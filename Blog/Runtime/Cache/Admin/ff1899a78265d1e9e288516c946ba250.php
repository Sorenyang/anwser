...
<body>
	...
	<div id="left">
		...
		<dl>
			...
			<dd><a href="<?php echo U(GROUP_NAME.'/Attr/index');?>">属性列表</a></dd>
			<dd><a href="<?php echo U(GROUP_NAME.'/Attr/addAttr');?>">添加属性</a></dd>
		</dl>
		<dl>
			<dt>分类管理</dt>
	...
	<div id="right">
		<iframe name="iframe" src="<?php echo U('Admin/Index/copy','','');?>"></iframe>
	</div>
</body>
</html>