...
<div class="ibody">
  ...
  <article>
    <h2 class="about_h">您现在的位置是：<a href="/">首页</a>><a href="1/">博文日志</a></h2>
    <div class="bloglist">
      <?php if(is_array($list)): foreach($list as $key=>$v): ?><div class="newblog">
        <ul>
          <h3><a href="<?php echo U(GROUP_NAME.'/List/show',array('id'=>$v['id']));?>"><?php echo ($v["title"]); ?></a></h3>
          <div class="autor"><span>作者：杨东</span><span>分类：[<a href="/"><?php echo ($v["catename"]); ?></a>]</span><span>浏览（<a href="/"><?php echo ($v["click"]); ?></a>）</span></div>
          <p><?php echo ($v["summary"]); ?><a href="<?php echo U(GROUP_NAME.'/List/show',array('id'=>$v['id']));?>" target="_blank" class="readmore">全文</a></p>
        </ul>
