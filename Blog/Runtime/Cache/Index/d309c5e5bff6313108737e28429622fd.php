...
<body>
  ...
  <article>
    ...
    <div class="template">
      ...
      <ul>
        <?php if(is_array($img)): foreach($img as $key=>$v): ?><li><a href="<?php echo U(GROUP_NAME.'/Image/img',array('id'=>$v['id']));?>"  target="_blank"><img src="__PUBLIC__/images/<?php echo ($v["images"]); ?>"></a><span><?php echo ($v["alt"]); ?></span></li><?php endforeach; endif; ?>
      </ul>
